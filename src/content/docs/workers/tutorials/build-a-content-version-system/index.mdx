...
- Cloudflare account (Paid plan so you can use Durable Objects - $5/month, in the time of writing this tutorial)
...
- Flows of operation: reading the state → making changes → writing the changes
